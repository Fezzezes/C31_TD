...
class Vue:
    ...
    def creer_frame_aire_jeu(self):
        ...
        bouton_construction.place(relx=0.6, rely=0.1, anchor="center",
                                  relheight=0.1, relwidth=0.1)
        bouton_amelioration.place(relx=0.8, rely=0.1, anchor="center",
                                  relheight=0.1, relwidth=0.1)
    ...
    def afficher_troncons(self):
        ...
        for t in self.modele.troncons:
            jeu.create_rectangle(t.posX, t.posY, (t.posX + t.largeur),
                                 (t.posY + t.hauteur), tags=("permanent",),
                                 fill="red")
